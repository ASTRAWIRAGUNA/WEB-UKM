<aside id="sidebar">
    ...
    <ul class="sidebar-nav">
        <li class="sidebar-item {{ request()->routeIs('dashboard-admin.index') ? 'active' : '' }}">
            <a href="{{ route('dashboard-admin.index') }}" class="sidebar-link">
                <i class="fa-solid fa-gauge"></i>
                <span>Dashboard</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->routeIs('manage-user.index') ? 'active' : '' }}">
            <a href="{{ route('manage-user.index') }}" class="sidebar-link">
                <i class="fa-regular fa-user"></i>
                <span>Manage User</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->routeIs('manage-ukm.index') ? 'active' : '' }}">
            <a href="{{ route('manage-ukm.index') }}" class="sidebar-link">
                <i class="fa-solid fa-users-rectangle"></i>
                <span>Manage UKM</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->routeIs('manage-laporan-ukm.index') ? 'active' : '' }}">
            <a href="{{ route('manage-laporan-ukm.index') }}" class="sidebar-link">
                <i class="fa-regular fa-circle-check"></i>
                <span>Laporan UKM</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->routeIs('log-activity.index') ? 'active' : '' }}">
