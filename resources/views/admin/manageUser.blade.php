  ...
  <div class="wrapper">
    ...
    <div class="main p-3">
      <div class="header d-flex justify-content-between align-items-center mb-4" >
        <div class="fw-bold fs-3">Manage User</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('import.users') }}" method="POST">
            ...
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">file excel</label>
              <input type="file" class="form-control shadow-none" name="file" id="exampleInputPassword1">
            </div>
